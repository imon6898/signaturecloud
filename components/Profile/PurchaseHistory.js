...
const PurchaseHistory = (props) => {
  ...
  const columns = [
    ...
    },
    {
      name: t("amount"),
      selector: (row) =>
        (settings.settingsData?.currency?.symbol || "Tk") + " " + row.payAmount,
    },
    {
  ...
  console.log(
    "Check Symbol: ",
    typeof settings.settingsData.currency.symbol || "Tk"
  );
  console.log("Check Columns: ", typeof filteredItems[0]?.payAmount);
