...
const seedData = {
  settings: {
    name: "DeshIT-BD",
    currency: { name: "Tk", symbol: "TK", exchangeRate: 1 },
    title: "Ecommerce Shopping Platform",
    address: "D/36 Block-E, Lalmatiya, Dhaka-1207",
    email: "info@deshit-bd.com",
    shortAddress: "Lalmatiya, Dhaka-1207",
    social: {
    ...
    phoneFooter: "+8801813320587",
    phoneHeader: "+8801813320587",
    copyright: "© 2025 - DeshIT-BD™",
    favicon: [
      {
        name: "fav.png",
        url: `${url}/fav.png`,
